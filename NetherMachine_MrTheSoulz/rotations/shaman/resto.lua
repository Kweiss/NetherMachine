...
mts.Splash("|cff9482C9[MTS]-|cffFFFFFF"..(select(2, GetSpecializationInfo(GetSpecialization())) or "Error").."-|cff9482C9Loaded", 5.0)
  	...
  	NetherMachine.toggle.create('dispel', 'Interface\\Icons\\Ability_paladin_sacredcleansing.png', 'Dispel Everything', 'Dispels everything it finds \nThis does not effect SoO dispels.')
...
NetherMachine.rotation.register_custom(264, mts.Icon.."|r[|cff9482C9MTS|r][|cff0070DETesting Shaman-Resto|r]", inCombat, outCombat, lib)