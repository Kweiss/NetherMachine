...
mts.Splash("|cff9482C9[MTS]-|cffFFFFFF"..(select(2, GetSpecializationInfo(GetSpecialization())) or "Error").."-|cff9482C9Loaded", 5.0)
  	...
  	NetherMachine.toggle.create('cleave', 'Interface\\Icons\\spell_frost_frostbolt', 'Disable Cleaves', 'Disable casting of Cone of Cold and Ice Nova for Procs.')
...
NetherMachine.rotation.register_custom(64, mts.Icon.."|r[|cff69CCF0MTS|r][|cff69CCF0Mage-Frost|r]", inCombat, outCombat, lib)