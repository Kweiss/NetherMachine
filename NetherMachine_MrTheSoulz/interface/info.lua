...
local _Header = {
	type = "texture",texture = "Interface\\AddOns\\NetherMachine\\NetherMachine_MrTheSoulz\\media\\splash.blp",
	width = 200,
	height = 100,
	offset = 90,
	y = 42,
...
local mts_info = {
	...
	config = {
		...
		{ type = 'spacer' },
			...
			{
				type = "text",
				text = "NM Version Status: ",
				size = 11,
				offset = -11
			},
			{
				key = 'current_NMStatus',
				type = "text",
				text = "Loading...",
				size = 11,
				align = "right",
		...
		{ type = 'spacer' },
			...
			{ type = 'text', text = "If you have any issues while using it and the Status say they are okay, please visit: |cffC41F3Bhttp://www.ownedcore.com/forums/world-of-warcraft/world-of-warcraft-bots-programs/NetherMachine-engine/combat-routines/498642-pe-mrthesoulzpack.html|r for futher help."},
			...
			},
			{
				...
				callback = function()
					if FireHack then
						OpenURL("http://www.ownedcore.com/forums/world-of-warcraft/world-of-warcraft-bots-programs/NetherMachine-engine/combat-routines/498642-pe-mrthesoulzpack.html");
					else
						message("|cff00FF96Please Visit:|cffFFFFFF\nhttp://www.ownedcore.com/forums/world-of-warcraft/world-of-warcraft-bots-programs/NetherMachine-engine/combat-routines/498642-pe-mrthesoulzpack.html");
					end
				end
			},
			{
...
local function mts_updateLiveInfo()
	-- General Status
	InfoWindow.elements.current_Unlocker:SetText(NetherMachine.pmethod == nil and NetherMachine.protected.method == nil and "|cffC41F3BYou're not Unlocked, please use an unlocker." or "|cff00FF96You're Unlocked, Using: ".. (NetherMachine.pmethod or NetherMachine.protected.method))
	InfoWindow.elements.current_NMStatus:SetText(NetherMachine.version == mts.peRecomemded and "|cff00FF96You're using the recommeded NM version." or "|cffC41F3BYou're not using the recommeded NM version.")
...
function mts.InfoGUI()
	if not mts_OpenInfoWindow then
		InfoWindow = NetherMachine.interface.buildGUI(mts_info)
