...
local function onDragStop(self)
  ...
  NetherMachine.config.write('mts_minimap_position', minimap.position)
end
...
local function mts_createMinimap()
	...
	icon:SetSize(21, 21)
	icon:SetTexture('Interface\\AddOns\\NetherMachine\\NetherMachine_MrTheSoulz\\media\\toggle.blp')
	...
	minimap.position = NetherMachine.config.read('mts_minimap_position', -36)
	reposition()
