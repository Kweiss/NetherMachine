-- SPEC ID 63
NetherMachine.rotation.register_custom(63, '|cff69ACC8MageTestSquad|r', {
...
{ "#trinket1", "toggle.burn" },
{ "#trinket2", "toggle.burn" },
...
function()
  ...
  NetherMachine.toggle.create('usescorch', 'Interface\\ICONS\\Spell_fire_soulburn', 'Use Scorch', 'If you have the BIS trinket use this')
