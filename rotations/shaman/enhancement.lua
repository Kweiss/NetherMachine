-- SPEC ID 263
NetherMachine.rotation.register(263, {
  ...
  NetherMachine.toggle.create('totems', 'Interface\\ICONS\\ability_shaman_totemrelocation', 'Totems', 'Toggle the placement of totems.')
end)
