...
-- Custom Paladin Retribution  - WoD 6.1.2
-- Created on 05/06/15
-- Updated on 05/08/2015 @ 22:36
-- Version 1.0.2
-- Status: Functional - Beta Stage [ Estimated Completion: ~100% ]
-- Notes: Profile to match SimCraft T17-Mythic Action Rotation Lists
...
NetherMachine.rotation.register_custom(70, "|cff660099Nether|r|cffFF0074Machine |cfff58cbaPaladin Retribution |cffff9999(SimC T17H/M) |cff336600Ver: |cff3333cc1.0.2", {
---- *** COMBAT ROUTINE SECTION ***
	...
	{	{
		...
		{ "Divine Storm", { "!toggle.limitaoe", "player.buff(Divine Crusader)", "player.buff(Holy Avenger)", "player.holypower >= 3", "player.buff(Final Verdict)" } },
		...
		{ "Divine Storm", { "!toggle.limitaoe", "player.buff(Divine Crusader)", "player.holypower == 5", "player.area(8).enemies == 2", "!talent(7, 3)" } },
		{ "Divine Storm", { "!toggle.limitaoe", "player.buff(Divine Crusader)", "player.buff(Holy Avenger)", "player.holypower >= 3", "player.area(8).enemies == 2", "!talent(7, 3)" } },
		-- actions.single+=/divine_storm,if=(holy_power=5|buff.holy_avenger.up&holy_power>=3)&active_enemies=2&buff.final_verdict.up
		{ "Divine Storm", { "!toggle.limitaoe", "player.holypower == 5", "player.area(8).enemies == 2", "player.buff(Final Verdict)" } },
		{ "Divine Storm", { "!toggle.limitaoe", "player.buff(Holy Avenger)", "player.holypower >= 3", "player.area(8).enemies == 2", "player.buff(Final Verdict)" } },
		...
		{ "Divine Storm", { "!toggle.limitaoe", "player.buff*(Divine Crusader)","player.holypower == 5", "talent(7, 2)", "player.spell(Seraphim).cooldown < 5.5" } },
		{ "Divine Storm", { "!toggle.limitaoe", "player.buff*(Divine Crusader)","player.buff(Holy Avenger)", "player.holypower >= 3", "talent(7, 2)", "player.spell(Seraphim).cooldown < 5.5" } },
		...
		{ "Divine Storm", { "!toggle.limitaoe", "player.buff(Divine Crusader)", "player.buff(Divine Crusader).remains < 3", "!talent(7, 3)"} },
		-- actions.single+=/divine_storm,if=buff.divine_crusader.react&buff.divine_crusader.remains<3&buff.final_verdict.up
		{ "Divine Storm", { "!toggle.limitaoe", "player.buff(Divine Crusader)", "player.buff(Divine Crusader).remains < 3", "player.buff(Final Verdict)" } },
		...
		{ "Divine Storm", { "!toggle.limitaoe", "player.area(8).enemies == 2", "player.buff(Final Verdict)", "player.buff(Avenging Wrath)" } },
		{ "Divine Storm", { "!toggle.limitaoe", "player.area(8).enemies == 2", "player.buff(Final Verdict)", "target.health < 35" } },
		...
		{ "Divine Storm", { "!toggle.limitaoe", "player.buff(Divine Crusader)", "player.area(8).enemies == 2", "player.buff(Avenging Wrath)", "!talent(7, 3)" } },
		{ "Divine Storm", { "!toggle.limitaoe", "player.buff(Divine Crusader)", "player.area(8).enemies == 2", "target.health < 35", "!talent(7, 3)" } },
		...
		{ "Exorcism", { "!toggle.limitaoe", "player.holypower < 5", "player.glyph(122028)", "!player.glyph(121027)", "!player.glyph(54922)", "player.area(8).enemies >= 2" } },
		...
		{ "Divine Storm", { "!toggle.limitaoe", "player.area(8).enemies == 2", "player.holypower >= 4", "player.buff(Final Verdict)" } },
		...
		{ "Divine Storm", { "!toggle.limitaoe", "player.buff(Divine Crusader)", "player.area(8).enemies == 2", "player.holypower >= 4", "!talent(7, 3)" } },
		...
		{ "Divine Storm", { "!toggle.limitaoe", "player.area(8).enemies == 2", "player.holypower >= 3", "player.buff(Final Verdict)" } },
