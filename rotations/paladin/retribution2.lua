...
-- Updated on Jan 3rd 2015

-- SUGGESTED TALENTS: 2112333
-- SUGGESTED GLYPHS: winged_vengeance/templars_verdict/righteous_retreat/fire_from_the_heavens/judgment
-- CONTROLS: Pause - Left Control

 
NetherMachine.rotation.register_custom(70, "bbPaladin Retribution (SimC T17N)", {
-- COMBAT ROTATION
  -- PAUSES
  ...
  { "Execution Sentence", "player.health <= 60", "player" },
  { "Execution Sentence", "player.health > 60", "target" },
  ...
  { {
    ...
    "player.area(8).enemies >= 3", "modifier.multitarget",
  } },
  ...
  { "Divine Storm", { "!talent(7, 3)", "player.buff(Divine Crusader)", "player.buff(Divine Crusader).remains < 3" } },
  ...
  { "Seal of Righteousness", { "talent(7, 1)", "player.seal != 2", "!player.buff(Liadrin's Righteousness)", "!player.buff(Avenging Wrath)", "!player.hashero" } },
  ...
  { "Templar's Verdict", { "target.health < 35", "talent(7, 2)", "player.spell(Seraphim).cooldown > 5" } },
  ...
  { "Templar's Verdict", { "player.holypower >= 4", "talent(7, 2)", "player.spell(Seraphim).cooldown > 5" } },
  ...
  { "Divine Storm", { "player.holypower >= 3", "!talent(7, 2)" } },
  { "Divine Storm", { "player.holypower >= 3", "talent(7, 2)", "player.spell(Seraphim).cooldown > 6" } },
...
NetherMachine.rotation.register_custom(70, "bbPaladin Retribution (OLD)", {
-- COMBAT ROTATION
  -- PAUSE
  { "pause", "modifier.lcontrol" },
